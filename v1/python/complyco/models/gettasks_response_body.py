...
class GettasksResponseBody(BaseModel):
    ...
    tasks: Optional[List[GettasksTaskDetails]] = None
    __properties: ClassVar[List[str]] = ["message", "tasks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [GettasksTaskDetails.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
