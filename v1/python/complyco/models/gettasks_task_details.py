...
class GettasksTaskDetails(BaseModel):
    """
    GettasksTaskDetails
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["cancelled_at", "completed_at", "document_name", "expires_at", "id", "identity_email", "identity_id", "scroll_required", "signature_required"]
